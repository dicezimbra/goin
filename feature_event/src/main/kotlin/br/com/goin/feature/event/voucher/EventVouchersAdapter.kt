package br.com.goin.feature.event.voucher
...
import kotlinx.android.synthetic.main.item_voucher_event.view.*

class EventVouchersAdapter(var vouchers: List<ApiVoucher>) : RecyclerView.Adapter<EventVouchersAdapter.ViewHolder>() {

    var onClickVoucherListener: ((voucher: ApiVoucher) -> Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return ViewHolder(inflater.inflate(R.layout.item_voucher_event, parent, false))
    }
