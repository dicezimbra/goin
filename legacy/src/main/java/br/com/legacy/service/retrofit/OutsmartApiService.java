...
public interface OutsmartApiService {
    ...
    @POST("graphql")
    Call<OutsmartResponse<QueryResponse>> getBanner(@Body GraphqlQuery body);
    ...
    @POST("graphql")
    Call<OutsmartResponse<SearchFilterResponse>> filterResults(@Body GraphqlQuery body);

    @POST("graphql")
    Call<OutsmartResponse<StatesList>> getStates(@Body GraphqlQuery body);

    @POST("graphql")
    Call<OutsmartResponse<CitiesList>> getCities(@Body GraphqlQuery body);
    ...
    @POST("graphql")
    Call<OutsmartResponse<QueryResponse>> confirmTokenIsValid(@Body GraphqlQuery body);
    ...
    @POST("graphql")
    Call<OutsmartResponse<QueryResponse>> updatePartnerInfo(@Body GraphqlQuery graphqlQuery);

    @POST("graphql")
    Call<OutsmartResponse<QueryResponse>> hasUpdates(@Body GraphqlQuery graphqlQuery);

    @POST("graphql")
    Call<OutsmartResponse<QueryResponse>> validateCoupom(@Body GraphqlQuery graphqlQuery);
}
