...
public class ConnectingLineOS {
     ...
     */
    public ConnectingLineOS(Context ctx, float y, float connectingLineWeight,
     ...
     */
    public void draw(Canvas canvas, PinViewOS leftThumb, PinViewOS rightThumb) {
     ...
     */
    public void draw(Canvas canvas, float leftMargin, PinViewOS rightThumb) {
