...
object PostUtils {
    ...
    private val TAG = PostUtils::class.java.simpleName
    private const val TAG_HASH = "d9d1d"
    ...
    fun getSmallImage(context: Context, uri: Uri): Bitmap? {
    ...
    fun getLargeImage(context: Context, uri: Uri): Bitmap? {
        return getBitmap(context, uri, 1800, 1800)
    }

    fun decodeUriAsBitmap(context: Context, uri: Uri, width: Int, height: Int): Bitmap? {
