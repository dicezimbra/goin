...
public class Constants {
    ...
    public static String POST_POS = "POST_POS";
    ...
    public static String FILTER_TIME_PERIOD = "FILTER_TIME_PERIOD";
    public static String FILTER_PARTY = "FILTER_PARTY";
    public static String SELECTED_SUB_CATEGORY = "SELECTED_SUB_CATEGORY";
    public static String ACTIVATED_FILTER = "ACTIVATED_FILTER";
    ...
    public static final int SEARCH_LOCATION = 8522;
...
//    public static final String
    ...
    public static final String MOVIE_DETAIL_TITLE = "movieTitle";
    public static final String MOVIE_DETAIL_CATEGORY = "movieDetailCategory";
    public static final String MOVIE_DETAIL_PARENTAL_CONTROL = "movieDetailParentalControl";
    public static final String MOVIE_DETAIL_DURATION = "movieDetailDuration";
    public static final String MOVIE_DETAIL_ABOUT = "movieAbout";
    public static final String MOVIE_DETAIL_URL_IMAGE = "urlImage";
